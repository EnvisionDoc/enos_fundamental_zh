...
支持用户在EnOS Edge上查看由接入Edge的子设备构成的资产树。这些资产树只显示EnOS Edge关联的逻辑资产所在节点以及EnOS Edge的子设备挂载的节点。参见[资产树管理](/docs/device-connection/latest/latest/howto/asset_tree/index)。
