...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS 基础} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{30pt}{\baselineskip}\selectfont \textbf{基础}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'基础',
     u'远景智能', 'book', 'true'),
]
